...
## 注意：本项目参照[https://gitee.com/tingyuabc/maven-aggregation-quickstart](https://gitee.com/tingyuabc/maven-aggregation-quickstart)
---
...
构建完成后，插件的 `.zip` 文件会生成在 `build/distributions/` 目录下。
...
4. 选择 `build/distributions/maven-aggregation-3.0.0.zip`。
