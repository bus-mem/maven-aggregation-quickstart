...
public class MavenAggregationProjectGenerator extends WebProjectTemplate<MavenAggregationSettings> {
     ...
     */
    public void generateProject(@NotNull Project project, @NotNull String groupId,
        @NotNull String artifactId, @NotNull String[] modules, boolean addDependencies,
        boolean isSingleModule, String domainName) {
        // 调用核心生成器，支持单模块/多模块模式
        AggregationProjectGenerator generator = new AggregationProjectGenerator();
